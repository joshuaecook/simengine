...
function startup ()
  ...
  if not(settings.general.quiet.getValue()) and settings.general.startupmessage.getValue() then
      ...
      // RKW 2/22/2011: We can add back an auto-update in the future in its new home at Google code, but for now, we should just remove it.
      ...
      // 		println("at simengine.googlecode.com.")
      // 		println(" ")
      // 	    end
      // 	end
      // end
