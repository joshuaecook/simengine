...
model (V, Iapp) = brk_inputs(Iext)
  ...
  constant GCa_NS = 14
  constant GCa_ND = .03
  // Set KCa conductances to simulated application of Apamine, or 5-HT, leading to bistable behavior
  constant GK_CaS = 3.136  // canonical: 5
  constant GK_CaD = 0.69   // canonical: 1.1
  constant GCa_L = 0.33 
  constant gleak = 0.51 
  ...
  // Choose a variable time step solver for enhanced performance
  solver = ode23
