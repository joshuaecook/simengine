    ...
    [{group="General Options",
     ...
     {group="Logging Options",
      ...
      options=[{short=NONE,
		...
		xmltag="logast",
		dyntype=FLAG_T,
		description=["Enable/disable logging of ast data structure"]},
	       {short=NONE,
		long =SOME "logdof",
		xmltag="logdof",
		dyntype=FLAG_T,
		description=["Enable/disable logging of dof data structure"]},
	       {short=NONE,
		long =SOME "logoutline",
		xmltag="logoutline",
		dyntype=FLAG_T,
		description=["Enable/disable logging of dof outline data structure"]},
	       {short=NONE,
		long =SOME "logauto",
		xmltag="logauto",
		dyntype=FLAG_T,
		description=["Enable/disable logging of auto iterator expansion"]},
	       {short=NONE,
		...
		xmltag="logspaces",
		dyntype=FLAG_T,
		description=["Enable/disable logging of spaces"]},
	       {short=NONE,
     ...
     {group="Optimization Settings",
      ...
      options=[{short=SOME #"O",
		...
		description=["Enable/disable optimizations"]},
	       {short=NONE,
		long=SOME "optimizelevel",
		xmltag="optimizelevel",
		dyntype=INTEGER_T,
		description=["Set the optimization level (0 to 5)"]},
	       {short=NONE,
		long=SOME "aggregate",
		xmltag="aggregate",
		dyntype=FLAG_T,
     ...
     {group="Installation Settings",
      ...
      options=[{short=NONE,
		...
		description=["Do not load simEngine, only check dependencies and return success/failure in the exit status"]},
	       {short=NONE,
		long=SOME "updateQuery",
		xmltag="updateQuery",
		dyntype=STRING_T,
		description=["Query string parameters which are appended to URLs for version checking and downloading updates."]},
	       {short=NONE,
		long =SOME "versionURL",
		xmltag="versionURL",
		dyntype=STRING_T,
		description=["The URL where simEngine version information is located"]},
	       {short=NONE,
		long =SOME "updateURL",
		xmltag="updateURL",
		dyntype=STRING_T,
     ...
     {group="Simulation Settings",
      ...
      options=[{short=SOME #"b",
		...
		xmltag="complex",
		dyntype=FLAG_T,
		description=["Enable use of complex numerics"]},
	       {short=NONE,
		long =SOME "precision",
		xmltag="precision",
		dyntype=STRING_T,
     ...
     {group="GPU Settings",
      ...
      options=[{short=NONE,
		...
		description=["Set the ID of the GPU that simEngine should utilize"]},
	       {short=NONE,
		long =SOME "gpu_block_size",
		xmltag="gpu_block_size",
		dyntype=INTEGER_T,
		description=["Override the GPU blocksize - number of threads per block"]},
	       {short=NONE,
		long =SOME "max_iterations",
		xmltag="max_iterations",
		dyntype=INTEGER_T,
		description=["Override the GPU max iterations per kernel invocation, needed for GPU's used as display"]}]},
