  /* ********************************************************************************************** */
  // fast low voltage activated K Current Kv4_fast
model (I) = chan_Kv4_f (V, G_Kv4_f, E_K)
  ...
  */
  ...
  /*
  PARAMETER tau_h_min (0.001 TO 0.010 BY 0.0005) = 0.007 //s
  PARAMETER tau_h_max (0.015 TO 0.030 BY 0.0005) = 0.021 //s
