...
s2.add(Test('BasicAlgebraicSubModelTest', ...
            @()(simex(['models_FeatureTests/AlgebraicSubModelTest1.dsl'], 10,'-quiet')), ...
            '-equal', struct('y', [0:10; 0:10; (0:10).^2]')));
s2.add(Test('MultipleIterators', ...
            @()(simex(['models_FeatureTests/AlgebraicSubModelTest2.dsl'], 10,'-quiet')), ...
            '-equal', struct('y', [0:10; 0:10; (0:10).^2.*3; (0:10).^2.*3]')));
s2.add(Test('IteratorOfOutput', ...
            @()(simex(['models_FeatureTests/AlgebraicSubModelTest4.dsl'], 10,'-quiet')), ...
            '-equal', struct('y', [0:10; (0:10).^2]', ...
                             'z', [0:10; 0:10]')));
s2.add(Test('IteratorOfIntermediate', ...
            @()(simex(['models_FeatureTests/AlgebraicSubModelTest5.dsl'], 10,'-quiet')), ...
            '-equal', struct('y', [0:10; (0:10).^2]', ...
                             'z', [0:10; 0:10]')));
