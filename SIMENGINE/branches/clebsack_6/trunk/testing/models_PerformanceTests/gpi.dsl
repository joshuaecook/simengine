model (Vm, spike, tmp) = gpi(excitatoryInput, inhibitoryInput) 
	...
	Iahp= gahp*(Vm-Ek)*(Ca/(Ca+k1))
        ...
        Ik2p1 = gk2p1*rinf*sinf*(Vm - Ek)

	IsynE = gsynE*(mSynE-hSynE)*(Vm-EsynE)
	IsynI = gsynI*(mSynI-hSynI)*(Vm-EsynI)

	Vm'=1/Cm*(-Il-Ik-Ina-It-Ica-Iahp-IsynE-IsynI+Iappgpe-Ik2p1)
