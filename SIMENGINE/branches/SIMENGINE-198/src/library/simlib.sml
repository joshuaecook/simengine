...
fun makeObjectFromFile exec =
    fn [KEC.LITERAL (KEC.CONSTSTR objectName), KEC.LITERAL (KEC.CONSTSTR filename)] => 
       (KEC.LITERAL (KEC.CONSTSTR (Simlib.makeObjectFromFile {objectName=objectName, filename=filename}))
