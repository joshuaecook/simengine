	...
	[
	 ...
	 SUB((if need_systemdata then
	     ...
	     [$(""),
	      ...
	      $("#if NUM_STATES > 0"),
	      $("#if defined TARGET_GPU"),
	      $("// on GPU targets, this structure is already wide enough for all models"),
	      $("memcpy(system_states_next, system_states_int, sizeof(systemstatedata_external));"),
	      $("#else"),
	      $("memcpy(system_states_next, system_states_int, NUM_MODELS * sizeof(systemstatedata_internal));"),
	      $("#endif"),
	      $("#endif"),
	      $("return props;")]),
	 $("}"),
