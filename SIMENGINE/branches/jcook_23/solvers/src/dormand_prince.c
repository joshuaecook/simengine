...
__DEVICE__ int SOLVER(dormand_prince, eval, TARGET, SIMENGINE_STORAGE, dormand_prince_mem *mem, unsigned int modelid) {
  ...
  while(!appropriate_step) {
    ...
    ret |= model_flows(mem->props->time[modelid]+(mem->cur_timestep[modelid]/5.0), mem->temp, mem->k2, mem->props->inputs, mem->props->outputs, 0, modelid, threadid, mem->props);
    ...
    ret |= model_flows(mem->props->time[modelid]+(3.0*mem->cur_timestep[modelid]/10.0), mem->temp, mem->k3, mem->props->inputs, mem->props->outputs, 0, modelid, threadid, mem->props);
    ...
    ret |= model_flows(mem->props->time[modelid]+(4.0*mem->cur_timestep[modelid]/5.0), mem->temp, mem->k4, mem->props->inputs, mem->props->outputs, 0, modelid, threadid, mem->props);
    ...
    ret |= model_flows(mem->props->time[modelid]+(8.0*mem->cur_timestep[modelid]/9.0), mem->temp, mem->k5, mem->props->inputs, mem->props->outputs, 0, modelid, threadid, mem->props);
    ...
    ret |= model_flows(mem->props->time[modelid]+mem->cur_timestep[modelid], mem->temp, mem->k6, mem->props->inputs, mem->props->outputs, 0, modelid, threadid, mem->props);
    ...
    ret |= model_flows(mem->props->time[modelid]+mem->cur_timestep[modelid], mem->next_states, mem->k7, mem->props->inputs, mem->props->outputs, 0, modelid, threadid, mem->props);
