...
model (Vm, Raxonal) = synapseCompartment(Iaxonal, length, diameter, gNa, gK1, gK2, gKA, gh, gP, gCaF, gCaS, Rm, Eleak, Vpre)
...
equations
   ...
   Cmem = Cm*SA*1e3	                        //nF
	...
	ISyn = GSyn * fSyn * MSyn * (Vm - ESyn)

   ICmem = -(Iaxonal + INa + IP + ICaF + ICaS+ IK1 + IK2 + IKA + Ih + Ileak + ISyn)
