...
%s.add(Test('NormalDistribution', @()(simex(['models_FeaturesTests/' ...
%                    'RandomTest2.dsl'], 10, target))))
s.add(Test('MixedDistribution', @()(simex(['models_FeaturesTests/' ...
                    'RandomTest3.dsl'], 10, target))))
