...
structure DMLLCParse : PARSE = 
struct 

  structure LrVals = DMLLrValsFun(structure Token=LrParser.Token)
  structure Lex = DMLLexFun(structure Tokens=LrVals.Tokens)
