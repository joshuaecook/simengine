	...
	fun init_props iter_sym =
		...
		fun progs () =
			...
			[(* HACK BEGIN *)
			 ...
			 $("props[ITERATOR_"^itername^"].dirty_states = (int*)calloc(PARALLEL_MODELS, sizeof(unsigned int));"),
			 $("props[ITERATOR_"^itername^"].ready_outputs = (int*)calloc(PARALLEL_MODELS, sizeof(unsigned int));"),
